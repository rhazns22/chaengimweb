...
> 챙김은 실제 대상 여부나 신청 가능 여부를 보장하지 않습니다.  
...
| --- | --- |
| Landing Demo | 준비 중 |
| App Demo | https://chaengim.vercel.app/ |
| GitHub | https://github.com/rhazns22 |
| Portfolio | https://pjewep.vercel.app/ |
| Email | pje698112@naver.com |
...
- AI가 최종 대상 여부를 판단하지 않고 추천 이유를 설명하는 보조 도구로만 동작하도록 제한한 설계
...
챙김의 AI 추천은 최종 대상 여부를 판단하는 기능이 아니라, 조건 매칭 결과를 이해하기 쉽게 설명하는 보조 흐름으로 표현했습니다.
...
AI 추천은 최종 대상 여부를 판단하는 기능이 아니라, 조건 매칭 결과를 이해하기 쉽게 설명하는 보조 도구로 표현했습니다.
...
- Landing Demo와 저장소 상세 URL은 실제 배포/저장소 URL 확정 후 교체가 필요합니다.
- 랜딩사이트는 서비스 소개용 웹페이지이며, 공식 기관의 최종 확인 절차를 대신하지 않습니다.
- 챙김 앱은 실제 대상 여부나 신청 가능 여부를 보장하지 않으며, 최종 확인과 신청은 공식 기관 사이트에서 진행해야 합니다.
